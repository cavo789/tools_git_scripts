 ...
 * @version 1.3.1
 *
 * @see    https://github.com/markomarkovic/simple-php-git-deploy/
 */
...
if (!isset($_GET['sat']) || SECRET_ACCESS_TOKEN !== $_GET['sat'] || SECRET_ACCESS_TOKEN === 'BetterChangeMeNowOrSufferTheConsequences') {
...
<body>
<?php
if (!isset($_GET['sat']) || SECRET_ACCESS_TOKEN !== $_GET['sat']) {
    header($_SERVER['SERVER_PROTOCOL'] . ' 403 Forbidden', true, 403);
